...
-- DropForeignKey
ALTER TABLE "tier_list" DROP CONSTRAINT "tier_list_authorId_fkey";
...
-- AddForeignKey
ALTER TABLE "tier_list" ADD CONSTRAINT "tier_list_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
