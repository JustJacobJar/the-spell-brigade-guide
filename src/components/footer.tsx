import * as tsbIcon from "../../public/CommunityIcon.webp";
    ...
    <div className="flex w-full flex-col gap-2 p-4">
      ...
      <div className="flex flex-wrap gap-y-2">
        ...
        >
          ...
          <label>Join Our Discord</label>
        </a>
        <div className="divider divider-horizontal" />
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://github.com/JustJacobJar/the-spell-brigade-guide"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
        ...
        <div className="flex flex-col">
          <label className="text-xs text-neutral-400">Official Links</label>
          <div className="flex gap-2">
            <a
              className="flex items-center gap-2 hover:underline hover:underline-offset-4"
              href="https://discord.com/invite/WjyMS37Qx4"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              className="flex items-center gap-2 hover:underline hover:underline-offset-4"
              href="https://www.thespellbrigade.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <ImageUnop
